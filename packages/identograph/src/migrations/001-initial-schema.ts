...
export const statements: string[] = [
  ...
  "CREATE PROPERTY HAS_ACCESS.grantSource IF NOT EXISTS STRING",
  "CREATE PROPERTY HAS_ACCESS.justification IF NOT EXISTS STRING",
  "CREATE PROPERTY HAS_ACCESS.policyRef IF NOT EXISTS STRING",
  "CREATE PROPERTY HAS_ACCESS.lastReviewedAt IF NOT EXISTS DATETIME",
  ...
  "CREATE PROPERTY ASSIGNED_ROLE.grantSource IF NOT EXISTS STRING",
  "CREATE PROPERTY ASSIGNED_ROLE.justification IF NOT EXISTS STRING",
  "CREATE PROPERTY ASSIGNED_ROLE.policyRef IF NOT EXISTS STRING",
